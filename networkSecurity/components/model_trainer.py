...
from networkSecurity.entity.artifact_enity import ModelTrainerArtifacts , DataTransformationArtifacts
...
import mlflow
import dagshub
dagshub.init(repo_owner='AryanAjmera18', repo_name='NetworkSecurity_ML', mlflow=True)
...
class ModelTrainer:
    ...
    def track_mlflow(self,best_model,classification_metirc):
        with mlflow.start_run():
            f1_score = classification_metirc.f1_score
            precision_score = classification_metirc.precision_score
            recall_score = classification_metirc.recall_score
    ...
    def train_model(self,X_train,y_train,x_test,y_test):
        ...
        logging.info(f"Model selected is {best_model_name}")
