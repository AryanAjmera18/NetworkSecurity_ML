...
from networkSecurity.entity.artifact_enity import DataIngestionArtifacts
load_dotenv()
...
class DataIngestion:
    ...
    def split_data_as_train_test(self,dataframe:pd.DataFrame):
        try:
            ...
            logging.info("Train set ,test set created ")
            logging.info("Exited train test method of Data Ingestion_class ")
